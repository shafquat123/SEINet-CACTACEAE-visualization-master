...
nodeGenus = nodeGenus.filter((v, i, a) => a.indexOf(v) === i);
...
var element = d3.select('#viz-7').node();
...
var svg = d3.select("#viz-7").append("svg")
    .attr("width", width)
    .attr("height", height);
